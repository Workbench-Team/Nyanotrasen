...
ent-ClothingHeadHatTrucker = truckers hat
    ...
    .suffix = { "" }
ent-ClothingHeadPyjamaSyndicateBlack = black pyjama hat
    .desc = For keeping that head of yours warm.
    .suffix = { "" }
ent-ClothingHeadPyjamaSyndicatePink = pink pyjama hat
    .desc = For keeping that head of yours warm.
    .suffix = { "" }
ent-ClothingHeadPyjamaSyndicateRed = red pyjama hat
    .desc = For keeping that head of yours warm.
    .suffix = { "" }
