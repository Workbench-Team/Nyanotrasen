...
ent-ClothingUniformJumpsuitCargo = cargo tech jumpsuit
    ...
    .suffix = { "" }
ent-ClothingUniformJumpsuitSalvageSpecialist = salvage technician's jumpsuit
...
ent-ClothingUniformJumpsuitLawyerGood = good lawyer's suit
    ...
    .suffix = { "" }
ent-ClothingUniformJumpsuitPyjamaSyndicateBlack = black pyjamas
    .desc = For those long nights in perma.
    .suffix = { "" }
ent-ClothingUniformJumpsuitPyjamaSyndicatePink = pink pyjamas
    .desc = For those long nights in perma.
    .suffix = { "" }
ent-ClothingUniformJumpsuitPyjamaSyndicateRed = red pyjamas
    .desc = For those long nights in perma.
    .suffix = { "" }
