...
whitelist-end-round-kick = Игроки, не внесенные в белый список, автоматически удаляются в конце раунда. Чтобы подать заявку на внесение в белый список, подключитесь к Discord.
...
panic-bunker-no-admins =
     ...
     Если вы заинтересованы в Nyanotrasen, посетите наш Discord.
