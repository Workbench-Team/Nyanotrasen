...
alert-level-white-announcement = Уровень пси-поля на станции приближается к опасному уровню. Выключите все зонды напряжённости пси-поля. Ищите псионическую изоляцию. Экстрасенсы должны сообщать о нарушении разума или големизации. ROE на обоих поднят.
