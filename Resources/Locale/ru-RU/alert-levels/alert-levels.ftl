...
alert-level-white-announcement = Уровень мерцания на станции приближается к опасному уровню. Выключите все мерцающие зонды. Ищите псионическую изоляцию. Психологи должны сообщать о нарушении разума или големизации. ROE на обоих поднят.
