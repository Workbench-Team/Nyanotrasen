...
device-frequency-prototype-name-surveillance-camera-science = Камеры (Эпи)
...
device-frequency-prototype-name-surveillance-camera-silicon = Встроенные Силикон камеры
